            ...
            assert(up_contact + down_contact == 1); % there should only be one contact

            % get the projected goal 
            proj_smp = [p_smp(1), x_near.mu(2)];
            ...
            for i = 1:size(x_near.particles,1)
                ...
                delta_contact = [delta(1), 0]; % verticle slide
